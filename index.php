                                    ...
                                    <div class="row mt-30 ">
                                        <div class="col-md-11">
                                            <div class="panel" style="background-color: #DCDCDC">
                                                ...
                                                <div class="panel-body p-20" style="background-color: #808000">
                                                        <p class="sub-title" style="color: white">for students</p>
                                                    </div>
                                        ...
                                        <div class="col-md-11">
                                            <div class="panel" style="background-color: #DCDCDC">
                                                ...
                                                <div class="panel-body p-20" style="background-color: #808000">
                                                    ...
                                                    <div class="section-title">
                                                        <p class="sub-title" style="color: white">Enter admin credentials</p>
                                                    </div>
